...
echo '快取統計: hits=' . (stats[hits] ?? 'Unknown') . ', misses=' . (stats[misses] ?? 'Unknown') . ', size=' . (stats[size] ?? 'Unknown') . "\n";
...
echo '快取統計: hits=' . (cacheStats[hits] ?? 'Unknown') . ', misses=' . (cacheStats[misses] ?? 'Unknown') . ', size=' . (cacheStats[size] ?? 'Unknown') . "\n";
