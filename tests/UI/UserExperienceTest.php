...
class UserExperienceTest extends UITestCase
{
    ...
    {
        // 滑鼠移至提示元素
        $this->browserAction('click', '[data-tooltip]');
    ...
    {
        // 捲動到頁面底部
        $this->browserAction('scroll_down');
    ...
    {
        // 訪問不存在的頁面
        $this->browserAction('launch', 'http://localhost:8080/nonexistent');
