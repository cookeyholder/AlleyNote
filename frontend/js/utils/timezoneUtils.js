...
class TimezoneUtils {
    ...
    async utcToSiteTimezone(utcTimeString, format = "datetime") {
        ...
        try {
            ...
            const siteDate = new Date(
                utcDate.getTime() + offsetHours * 3600000
            );
    ...
    async siteTimezoneToUtc(siteTimeString) {
        ...
        try {
            ...
            const utcDate = new Date(
                siteDate.getTime() - offsetHours * 3600000
            );
    ...
    getCommonTimezones() {
        return [
            ...
            {
                value: "Asia/Taipei",
                label: "Asia/Taipei (台北時間 UTC+8)",
                offset: "+08:00",
            },
            {
                value: "Asia/Tokyo",
                label: "Asia/Tokyo (東京時間 UTC+9)",
                offset: "+09:00",
            },
            {
                value: "Asia/Shanghai",
                label: "Asia/Shanghai (上海時間 UTC+8)",
                offset: "+08:00",
            },
            {
                value: "Asia/Hong_Kong",
                label: "Asia/Hong_Kong (香港時間 UTC+8)",
                offset: "+08:00",
            },
            {
                value: "Asia/Singapore",
                label: "Asia/Singapore (新加坡時間 UTC+8)",
                offset: "+08:00",
            },
            {
                value: "America/New_York",
                label: "America/New_York (紐約時間)",
                offset: "-05:00/-04:00",
            },
            {
                value: "America/Los_Angeles",
                label: "America/Los_Angeles (洛杉磯時間)",
                offset: "-08:00/-07:00",
            },
            {
                value: "America/Chicago",
                label: "America/Chicago (芝加哥時間)",
                offset: "-06:00/-05:00",
            },
            {
                value: "Europe/London",
                label: "Europe/London (倫敦時間)",
                offset: "+00:00/+01:00",
            },
            {
                value: "Europe/Paris",
                label: "Europe/Paris (巴黎時間)",
                offset: "+01:00/+02:00",
            },
            {
                value: "Europe/Berlin",
                label: "Europe/Berlin (柏林時間)",
                offset: "+01:00/+02:00",
            },
            {
                value: "Australia/Sydney",
                label: "Australia/Sydney (雪梨時間)",
                offset: "+10:00/+11:00",
            },
        ];
    }
