...
class Container_ab92ce462d extends _PHPStan_f9a2208af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0349(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_ab92ce462d $container)
			{
	...
	public function createServiceContainer(): Container_ab92ce462d
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/tmp/4cnu41v17n3j2InKxMX',
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/4cnu41v17n3j2InKxMX|1|*|*|/usr/local/etc/php/php.ini:/usr/local/etc/php/conf.d/docker-fpm.ini:/usr/local/etc/php/conf.d/docker-php-ext-gd.ini:/usr/local/etc/php/conf.d/docker-php-ext-opcache.ini:/usr/local/etc/php/conf.d/docker-php-ext-pcntl.ini:/usr/local/etc/php/conf.d/docker-php-ext-sodium.ini:/usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini:/usr/local/etc/php/conf.d/xdebug.ini|3.4.5',
			],
		];
	}
