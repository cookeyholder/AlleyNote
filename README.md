...
> - 🔒 **資安先行 (Security-First)**：強制執行資安 TDD 流程，具備 JWT、CSRF、XSS、SQL 注入防護
> - 📊 **統計分析**：多維度數據分析與可視化儀表板
> - 🔑 **密碼安全**：強制密碼強度驗證與即時檢查
> - ⚡ **極致效能**：API 回應時間嚴格控制在 500ms 內，內建效能基準測試與快取優化
...
2. 遵循 DDD 架構原則開發
3. 撰寫/更新測試
4. 確保程式碼品質檢查通過（PHPStan Level 8, PHP CS Fixer）
