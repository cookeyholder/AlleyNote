...
| `APP_URL`      | 後端 API 網址 | `http://localhost:8081` | `https://api.your-domain.com` |
...
| 變數名稱                  | 說明          | 預設值                             | 範例                              |
| ------------------------- | ------------- | ---------------------------------- | --------------------------------- |
| `VITE_API_BASE_URL`       | 後端 API 網址 | `http://localhost:8081/api`        | `https://api.your-domain.com/api` |
...
| `ADMIN_PASSWORD` | 管理員密碼 | `Admin@123456`      | `StrongPassword@2024`   |
