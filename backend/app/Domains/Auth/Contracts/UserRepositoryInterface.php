...
interface UserRepositoryInterface
{
     ...
     * @return array<string, mixed><string, mixed>|null 使用者資料陣列或 null
     */
     ...
     * @return array<string, mixed><string, mixed>|null 驗證成功返回使用者資料，失敗返回 null
     */
     ...
     * @return array<string, mixed><string, mixed> 建立的使用者資料
     */
     ...
     * @param int $id 使用者 ID
     */
    public function update(int $id, array $data/** @var array<string, mixed> */): bool;
     ...
     */
    public function paginate(int $page = 1, int $perPage = 10, array $filters/** @var array<string, mixed> */ = []): array;
