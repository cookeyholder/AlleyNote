...
interface RefreshTokenRepositoryInterface
{
     ...
     * @return array<string, mixed><string, mixed>|null token資料，找不到時回傳null
     */
     ...
     * @return array<string, mixed><int, array<string, mixed>> token資料陣列
     */
     ...
     * @return array<string, mixed><string, mixed> 系統統計資訊
