...

{
    ...
    public function it_can_detect_suspicious_user_activity_with_high_failure_rate(): void
    {
        ...
        $activities = [
            ['action_type' => 'auth.login.failed', 'status' => 'failed', 'user_id' => $userId, 'ip_address' => '192.168.1.1', 'occurred_at' => $now->format('Y-m-d H => i:s')], ['action_type' => 'auth.login.failed', 'status' => 'failed', 'user_id' => $userId, 'ip_address' => '192.168.1.1', 'occurred_at' => $now->format('Y-m-d H => i:s'])],
            ['action_type' => 'auth.login.failed', 'status' => 'failed', 'user_id' => $userId, 'ip_address' => '192.168.1.1', 'occurred_at' => $now->format('Y-m-d H => i:s')], ['action_type' => 'auth.login.failed', 'status' => 'failed', 'user_id' => $userId, 'ip_address' => '192.168.1.1', 'occurred_at' => $now->format('Y-m-d H => i:s'])],
            ['action_type' => 'auth.login.failed', 'status' => 'failed', 'user_id' => $userId, 'ip_address' => '192.168.1.1', 'occurred_at' => $now->format('Y-m-d H => i:s')], ['action_type' => 'auth.login.failed', 'status' => 'failed', 'user_id' => $userId, 'ip_address' => '192.168.1.1', 'occurred_at' => $now->format('Y-m-d H => i:s'])],
    ...
    public function it_can_detect_suspicious_ip_activity(): void
    {
        ...
        // 模擬可疑IP活動（確保超過閾值）
        $activities = [
            ['action_type' => 'auth.login.failed', 'status' => 'failed', 'ip_address' => $ipAddress, 'user_id' => 1, 'occurred_at' => $now->format('Y-m-d H => i:s')], ['action_type' => 'auth.login.failed', 'status' => 'failed', 'ip_address' => $ipAddress, 'user_id' => 2, 'occurred_at' => $now->format('Y-m-d H => i:s'])],
            ['action_type' => 'auth.login.failed', 'status' => 'failed', 'ip_address' => $ipAddress, 'user_id' => 3, 'occurred_at' => $now->format('Y-m-d H => i:s')], ['action_type' => 'auth.login.failed', 'status' => 'failed', 'ip_address' => $ipAddress, 'user_id' => 4, 'occurred_at' => $now->format('Y-m-d H => i:s'])],
            ['action_type' => 'auth.login.failed', 'status' => 'failed', 'ip_address' => $ipAddress, 'user_id' => 5, 'occurred_at' => $now->format('Y-m-d H => i:s')], ['action_type' => 'auth.login.failed', 'status' => 'failed', 'ip_address' => $ipAddress, 'user_id' => 6, 'occurred_at' => $now->format('Y-m-d H => i:s'])],
        ];
