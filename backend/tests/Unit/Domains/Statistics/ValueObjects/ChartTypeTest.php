...
final class ChartTypeTest extends UnitTestCase
{
    ...
    public function testDefaultOptionsForLine(): void
    {
        ...
        $this->assertSame(['display' => true, 'position' => 'top'], $options['plugins']['legend']);
    }
    ...
    public function testDefaultOptionsForPieAndDoughnut(): void
    {
        ...
        $this->assertSame(['display' => true, 'position' => 'right'], $pieOptions['plugins']['legend']);

        $doughnutOptions = ChartType::Doughnut->getDefaultOptions();
        $this->assertSame(['display' => true, 'position' => 'right'], $doughnutOptions['plugins']['legend']);
    }
}
